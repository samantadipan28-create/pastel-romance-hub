...
const LoveTree = ({ glowIntensity = "normal" }: LoveTreeProps) => {
  ...
  useEffect(() => {
    ...
    const blossomPositions = [
      // Left main branch area
      { x: 35, y: 85 }, { x: 25, y: 75 }, { x: 40, y: 70 },
      { x: 30, y: 65 }, { x: 20, y: 80 }, { x: 45, y: 80 },
      { x: 28, y: 55 }, { x: 38, y: 60 }, { x: 22, y: 70 },
      // Right main branch area  
      { x: 165, y: 85 }, { x: 175, y: 75 }, { x: 160, y: 70 },
      { x: 170, y: 65 }, { x: 180, y: 80 }, { x: 155, y: 80 },
      { x: 172, y: 55 }, { x: 162, y: 60 }, { x: 178, y: 70 },
      // Upper left branch
      { x: 50, y: 50 }, { x: 45, y: 40 }, { x: 55, y: 45 },
      { x: 40, y: 45 }, { x: 60, y: 55 }, { x: 48, y: 35 },
      // Upper right branch
      { x: 150, y: 50 }, { x: 155, y: 40 }, { x: 145, y: 45 },
      { x: 160, y: 45 }, { x: 140, y: 55 }, { x: 152, y: 35 },
      // Top center area
      { x: 100, y: 30 }, { x: 95, y: 25 }, { x: 105, y: 25 },
      { x: 90, y: 35 }, { x: 110, y: 35 }, { x: 100, y: 20 },
      { x: 85, y: 40 }, { x: 115, y: 40 },
      // Fill gaps
