  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-nunito",
  {
    variants: {
      variant: {
        ...
        romantic: "bg-gradient-to-r from-primary to-rose text-primary-foreground shadow-glow hover:shadow-[0_0_40px_hsl(var(--primary)/0.6)] hover:scale-105 active:scale-95 animate-pulse-heart",
        love: "bg-rose text-primary-foreground shadow-card hover:bg-rose/90 hover:scale-110 active:scale-95 transition-transform",
        no: "bg-muted text-muted-foreground border-2 border-border hover:bg-muted/80 shadow-soft",
      },
      size: {
